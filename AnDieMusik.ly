...
%                                   Singing "An die Musik", for a voice with piano accompaniment
%
%                                           WITH SEPERATE PARTITION AND MIDI OUTPUT
...
%                                           
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                           1. SHEET IMPROVEMENTS / POUR AMÉLIORER LA PARTITION
%                                              
% MOVE A DYNAMIC TO THE RIGHT AND THE LEFT / DEPLACER UNE DYNAMIQUE VERS LA DROITE, LA GAUCHE
...
% Suppression of PointAndClick / SUPPRESSION DU PointAndClick
PDFSimple =
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                 2. IMPROVES THE VOLUME OF THE MIDI OUTPUT / POUR AMÉLIORER LE VOLUME DE LA SORTIE MIDI
%
% The volume of the melody has been fully extended (from 0 to 1)
...
%                                           FILE STRUCTURE
%
%  Contrary to what the original score suggests, the melody is repeated identically;
%  there are only a few graphical differences for the piano, with no effect on the playing
%  - measure 3: the chord "fad la re" is written "fad la" on the bottom staff, "re" on the top one, and in full on the
%    top staff on the 2nd pass (measure 23 in the original)
%  - measure 22, 2nd pass: the tie and the colon are above the notes, while they are below on the 2nd pass
%    (measure 42 in the original)
%
%  The melody and the two piano staves are in three parts: an introduction, a body (played twice) and an end.
%  The poem consists of two stanzas.
%
%  The score and MIDI outputs are separate (with adjustments to the volume of the MIDI output)
%
%  A. MELODY
%     A1. Notes
%     A2. Dynamics for MIDI output
%  B. LYRICS
%  C. PIANO
%     C1. PIANO UPPER: Notes
%     C2. PIANO BASS: Notes
%     C3. PIANO: Dynamics for score output
%     C4. PIANO: Dynamics for MIDI output
%  D. SCORE OUTPUT
%  E. MIDI OUTPUT
%
%                      SUGGESTIONS WELCOME FOR IMPROVING THE SHEET, MIDI OUTPUT OR CODING
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%% SHEET MUSIC SUMMARY / RÉSUMÉ POUR LA PARTITION
meloNotePart = {
...
%%%%%%%%%%%%%%%%%%%% MIDI SUMMARY / RÉSUMÉ POUR LE MIDI
meloNoteMidi = {
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                           A2. MELODY / MELODIE: Dynamics for MIDI output
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                           C1. PIANO UPPER: Notes
%                   (only some writing differences in: measures 3/23 and 22/42)
...
%%%%%%%%%%%%%%%%%%%% SUMMARY FOR SCORE / RÉSUMÉ POUR LA PARTITION
pianoBasNotePart = {
 \clef bass
 \time 2/2
 \key re \major
...
%%%%%%%%%%%%%%%%%%%% SUMMARY FOR MIDI / RÉSUMÉ POUR LE MIDI
pianoBasNoteMidi = {
 \set Staff.midiInstrument = "acoustic grand"
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                               C3. PIANO: Dynamics for score output / Dynamiques pour la sortie Partition
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                               C4. PIANO: Dynamics for MIDI output / Dynamiques pour la sortie Midi
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                             E. MIDI OUTPUT (pas de \layout) / SORTIE MIDI (pas de \layout)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
